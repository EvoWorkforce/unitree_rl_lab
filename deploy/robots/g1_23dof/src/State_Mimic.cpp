...
: FSMState(state_mode, state_string) 
{
    ...
    this->registered_checks.emplace_back(
        std::make_pair(
            ...
            FSMStringMap.right.at("NavigationPIDv1")
        )
    );
    this->registered_checks.emplace_back(
        std::make_pair(
