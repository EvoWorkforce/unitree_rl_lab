...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    robot.spawn.usd_path = (
        "/home/ubuntu/workspace/resources/robot_models/g1_29dof_rev_evo.usd"
    )
    # sensors
...
class RewardsCfg:
    ...
    base_height = RewTerm(
        func=mdp.base_height_l2, weight=-10, params={"target_height": 0.60}
    )  # Changed target height. Was 0.78
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: RobotSceneCfg = RobotSceneCfg(num_envs=4096, env_spacing=1)
    # Basic settings
