...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        zmp_xy = ObsTerm(func=mdp.zmp_xy_l2_obs, params={"asset_cfg": SceneEntityCfg("robot")})
...
class RewardsCfg:
    ...
    joint_deviation_legs = RewTerm(
        func=mdp.joint_deviation_l1,
        weight=-0.05,  # Allow for more leg movement
    ...
    base_height = RewTerm(func=mdp.base_height_l2, weight=-15.0, params={"target_height": 0.6})
    ...
    # Penalize torso leaning to one side
    torso_lean_side_penalty = RewTerm(
        func=mdp.torso_lean_side_penalty,
        weight=-10.0,
        params={
            "asset_cfg": SceneEntityCfg("robot"),
        },
