...
class RewardsCfg:
    ...
    track_ang_vel_z = RewTerm(
        func=mdp.track_ang_vel_z_exp, weight=1.0, params={
            "command_name": "base_velocity", "std": math.sqrt(0.25)
        }
    )

    # === Base link motion rewards ===
    ...
    flat_orientation = RewTerm(func=mdp.flat_orientation_l2, weight=-10.0)
    ...
    feet_height_symmetry = RewTerm(
        func=mdp.feet_height_symmetry,
        weight=-0.5,
        params={
            "target_height": 0.1,
            "tanh_mult": 2.0,
