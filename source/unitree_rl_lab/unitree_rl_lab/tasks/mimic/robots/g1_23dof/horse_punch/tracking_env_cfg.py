...
from unitree_rl_lab.assets.robots.unitree import UNITREE_G1_23DOF_MIMIC_ACTION_SCALE_23JOINTS
from unitree_rl_lab.assets.robots.unitree import UNITREE_G1_23DOF_MIMIC_CFG_23JOINTS as ROBOT_CFG
...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfg(
        ...
        motion_file=f"{os.path.dirname(__file__)}/horse_punch_with_standing_8sec_30hz.npz",
...
class ActionsCfg:
    ...
    JointPositionAction = mdp.JointPositionActionCfg(
        asset_name="robot", joint_names=[".*"], scale=UNITREE_G1_23DOF_MIMIC_ACTION_SCALE_23JOINTS, use_default_offset=True
    )
