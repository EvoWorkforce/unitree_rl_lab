...
UNITREE_MODEL_DIR = "/home/ubuntu/workspace/unitree_models/unitree_model"
UNITREE_ROS_DIR = "/home/ubuntu/workspace/unitree_models/unitree_ros"
...
UNITREE_G1_23DOF_MIMIC_CFG_23JOINTS = UnitreeArticulationCfg(
    # spawn=UnitreeUrdfFileCfg(
    #     asset_path=f"{UNITREE_ROS_DIR}/robots/g1_description/g1_29dof_rev_1_0.urdf",
    # ),
    spawn=UnitreeUsdFileCfg(
...
UNITREE_G1_23DOF_MIMIC_ACTION_SCALE_23JOINTS = {}
for a in UNITREE_G1_23DOF_MIMIC_CFG_23JOINTS.actuators.values():
    e = a.effort_limit_sim
    s = a.stiffness
    names = a.joint_names_expr
    if not isinstance(e, dict):
    ...
    for n in names:
        if n in e and n in s and s[n]:
            UNITREE_G1_23DOF_MIMIC_ACTION_SCALE_23JOINTS[n] = 0.25 * e[n] / s[n]
